  ...
  category: [
    {
      ...
      categorySubTxt: 'categoryArr.upto',
      color: appColors.divider,
    },
    {
      name: 'categoryArr.women',
      image: images.womenImage,
      categoryImg: images.category2,
      categorySubTxt: 'categoryArr.womanCollection',
      color: appColors.categoryColor1,
    },
    {
      name: 'categoryArr.men',
      image: images.menImage,
      categoryImg: images.category3,
      categorySubTxt: 'categoryArr.menCollection',
      color: appColors.divider,
    },
    {
      name: 'categoryArr.kid',
      image: images.kidsImage,
      categoryImg: images.category4,
      categorySubTxt: 'categoryArr.kidsCollection',
      color: appColors.categoryColor2,
    },
    {
      name: 'categoryArr.beauty',
      image: images.beautyImage,
      categoryImg: images.category5,
      categorySubTxt: 'categoryArr.beautyCollection',
      color: appColors.divider,
    },
    {
      name: 'categoryArr.footwear',
      image: images.footwearImage,
      categoryImg: images.category6,
      categorySubTxt: 'categoryArr.footWearCollection',
      color: appColors.categoryColor3,
    },
    {
      name: 'categoryArr.jewelery',
      image: images.jewelleryImage,
      categoryImg: images.category7,
      categorySubTxt: 'categoryArr.jewelleryCollection',
      color: appColors.divider,
    },
  ],

  bannerSection: [{image: images.banner1Image}, {image: images.banner2Image}],
